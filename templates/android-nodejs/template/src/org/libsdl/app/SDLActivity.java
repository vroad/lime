...
class SDLMain implements Runnable {
    ...
    public SDLMain(String[] args, String workDir, String logFilePath) {
    ...
    public void run() {
        ...
        Log.v("SDL", "Trying to run NodeJS with:");
        for (int i = 0; i < args.length; i++)
            Log.v("SDL", args[i]);
        int result = NodeJS.run(args, workDir, logFilePath);
        Log.v("SDL", "NodeJS exited with " + result);
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public void surfaceChanged(SurfaceHolder holder,
        ...
        if (SDLActivity.mSDLThread == null) {
            ...
            String[] args = new String[]{"node", SDLActivity.mFilePath};
            final Thread sdlThread = new Thread(new SDLMain(args, SDLActivity.mWorkDir, SDLActivity.mLogFilePath));
            enableSensor(Sensor.TYPE_ACCELEROMETER, true);
            sdlThread.start();
